...
- **Preference Configuration** - User-configurable settings for preview panel and view mode
  - `avro-explorer.preference.previewPanelOpen` - Control default preview panel state
  - `avro-explorer.preference.previewPanelHeight` - Set default preview panel height
  - `avro-explorer.preference.viewMode` - Set default view mode (both/schema/records)

### Technical

- Refactored preference storage to use VSCode configuration instead of globalState
